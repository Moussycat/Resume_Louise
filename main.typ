    ...
    #section(title: "Education")[
      ...
      #pad(left: 1em)[
        ...
        #icon-list((
          ...
          Analog electronics design( LTspice), Radio Frequency, Microwave circuits (Ansys HFSS, ADS), Patch antenna design, Embedded systems, Communication protocols, Brushless motors, RFID, EMC fundamentals, Battery, Energy harvesting, Multiphysics systems, Microelectronics fundamentals
      ...
      */
      #pad(left: 1em)[
        ...
        #icon-list((
          ...
          To ensure compliance with safety and performance standards, analysed the Euro NCAP requirements (child occupant protection) and carried out a review of the state of the art in existing RFID solutions, identifying best practices and potential improvements. We designed two prototypes: a tag integrated into the child seat to detect  presence, and a dashboard interface to display information and allow users to control the system (on/off). Through close collaboration with the team, we ensured seamless integration between the hardware and the user interface, resulting in a functional and user-friendly proof of concept. 
          ]),
        ))
        #highlight[Skills used:]
